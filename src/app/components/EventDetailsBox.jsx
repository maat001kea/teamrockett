...
//   return (
//     <section className={`max-w-xl mx-auto  space-y-4 ${className}`}>
//       <h1 className="text-3xl font-bold text-my-blue font-playfair">{title}</h1>

//       <p className="space-y-2 font-sans font-normal text-my-blue  leading-relaxed text-sm sm:text-base md:text-lg">{description}</p>

//       <div className="space-y-1 text-sm text-my-blue sm:text-base md:text-lg">
//         <p>
...
//         <p className="text-sm text-green-700  py-1 mt-2 font-sans font-medium ">Billetter tilbage: {ticketsLeft}</p>
