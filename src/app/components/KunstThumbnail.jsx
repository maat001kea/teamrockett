...
const KunstThumbnail = ({ images }) => {
  ...
  return (
    <div className="relative aspect-square w-full max-w-[600px] mx-auto">
      ...
      {/* svg frame overlay */}
      <img src={lightgray.src} alt="Museum Frame" className="absolute inset-0 w-full h-full z-20 pointer-events-none scale-[1.22]  max-[400px]:hidden" style={{ transformOrigin: "center" }} />
    </div>
  );
};
