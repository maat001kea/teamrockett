...
//   return (
//     <motion.button whileHover={{ scale: 1.05, backgroundColor: "#FFA04E" }} whileTap={{ scale: 0.95 }} transition={{ type: "spring", stiffness: 300 }} onClick={onClick} className={`bg-[#D97C2B] text-white px-6 py-2 font-noto font-regular shadow-md cursor${className}`}>
//       {children}
//     </motion.button>
//   );
// };
